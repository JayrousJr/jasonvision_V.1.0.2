...
class SocialMediaPolicy
{
    ...
    {
        if ($user->hasPermissionTo("View Social Media")) {
            return true;
        }
        return false;
    }
    ...
    {
        if ($user->hasPermissionTo("Create Social Media")) {
            return true;
        }
        return false;
    }
    ...
    {
        if ($user->hasPermissionTo("Edit Social Media")) {
            return true;
        }
        return false;
    }
    ...
    {
        if ($user->hasPermissionTo("Delete Social Media")) {
            return true;
        }
        return false;
    }
